...
public class CameraSource {
  ...
  private final GraphicOverlay graphicOverlay2;
  ...
  public CameraSource(Activity activity, GraphicOverlay overlay, GraphicOverlay overlay2) {
    this.activity = activity;
    graphicOverlay = overlay;
    graphicOverlay2 = overlay2;
  ...
  public void setMachineLearningFrameProcessor(VisionImageProcessor processor) {
    synchronized (processorLock) {
      ...
      selfie = new SegmenterProcessor(activity);
      ((SegmenterProcessor) selfie).overlay = graphicOverlay;
