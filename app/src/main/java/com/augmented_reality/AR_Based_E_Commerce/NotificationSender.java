...
public class NotificationSender{
        ...
        private static final String serverKey ="key="+"AAAA9B71fj0:APA91bHtZ94E6HkWQ1DdjeT6kJC7rfr_1fgV7PLE2c4QYTdMswDrIWLctVehz4aEnq5FNl-8UHE0x6DDCihap4ahUjEbtJhFPkkG6PNI2o1QiVhZc_zcLrgSGstk7q4Xh7snc8QQjDq3";
       ...
       private  NotificationSender(Context context){
        ...
        private void set_notification_data(String title,String body,String sender_id,String sender_name,String image_path,String sender_type,String receiver_id,String document_id,String sender_device_id,String receiver_device_id,String activity_type){
            ...
            if(SharedPrefManager.getInstance(context).getUser().isAdmin()){
                sender_type="Admin";
            }
            ...
            data.put("sender_location",SharedPrefManager.getInstance(context).getUser().getLocation());
